...
public class Expressao implements Serializable {
      ...
      /* Dica de implementação: todas as vezes que encontrar um 
	  operador, antes de inserí-lo na lista, pergunte se os dois últimos elementos da lista são numéricos, 
	  se sim, então retire estes dois elementos, execute a operação e insira o resultado na lista. Se não, 
